...
var NewSysUserPost = &SysUserPostRepository{}

// SysUserPostRepository 用户与岗位关联表 数据层处理
type SysUserPostRepository struct{}

// ExistUserByPostId 存在用户使用数量
func (r *SysUserPostRepository) ExistUserByPostId(postId string) int64 {
...
func (r *SysUserPostRepository) DeleteByUserIds(userIds []string) int64 {
...
// BatchInsert 批量新增信息
func (r *SysUserPostRepository) BatchInsert(sysUserPosts []model.SysUserPost) int64 {
	up := make([]string, 0)

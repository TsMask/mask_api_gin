...
// SelectByPage 分页查询集合
func (r SysLogOperate) SelectByPage(query map[string]any) map[string]any {
	// 查询条件拼接
...
// Select 查询集合
func (r SysLogOperate) Select(SysLogOperate model.SysLogOperate) []model.SysLogOperate {
	// 查询条件拼接
	var conditions []string
	var params []any
...
// SelectById 通过ID查询信息
func (r SysLogOperate) SelectById(operaId string) model.SysLogOperate {
...
// DeleteByIds 批量删除信息
func (r SysLogOperate) DeleteByIds(operaIds []string) int64 {

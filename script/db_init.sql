...
insert into sys_menu values('112',  '服务信息', '2',   '1',   'server-info',                          'monitor/server/info',      '1', '1', 'M', '1', '1', 'monitor:server:info',    '#',    'maskAdmin', REPLACE(unix_timestamp(now(3)),'.',''), '', 0, '服务监控菜单');
insert into sys_menu values('113',  '缓存信息', '2',   '2',   'cache-info',                           'monitor/cache/info',       '1', '1', 'M', '1', '1', 'monitor:cache:info',     '#',    'maskAdmin', REPLACE(unix_timestamp(now(3)),'.',''), '', 0, '缓存监控菜单');
